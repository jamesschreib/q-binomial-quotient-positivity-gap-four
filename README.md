...
The index-gap-four case of the q-binomial quotient positivity conjecture states that, for $4 \le k \le n$, if $\genfrac{[}{]}{0pt}{}{n}{k}_q/\genfrac{[}{]}{0pt}{}{n}{k-4}_q$ is a polynomial, then all its coefficients are nonnegative.
